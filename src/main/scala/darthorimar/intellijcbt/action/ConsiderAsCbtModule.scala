package darthorimar.intellijcbt.action
...
import darthorimar.intellijcbt.project.CbtExtraModuleType
import darthorimar.intellijcbt.project.settings.CbtProjectSettings

import scala.collection.JavaConverters._

class ConsiderAsCbtModule extends CbtProjectAction {
    ...
    val enabledOpt = for {
      ...
      target match {
        case dir: PsiDirectory
          if CBT.isCbtModuleDir(dir.getVirtualFile) && !moduleExists(dir) => true
        case _ => false
      }
    }
